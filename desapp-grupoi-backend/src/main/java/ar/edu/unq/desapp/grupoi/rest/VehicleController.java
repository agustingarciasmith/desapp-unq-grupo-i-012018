...
public class VehicleController {
  ...
  public VehicleDTO createVehicle(@RequestBody VehicleDTO vehicle) {
    logger.info(String.format("Agregando Vehiculo a usuario => %s %s %s %s", vehicle.getVehicleId(), vehicle.getVehicleType(), vehicle.getLicense(), vehicle.getNumberOfPassengers()));
